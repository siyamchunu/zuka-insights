...
excel_path = '/home/siya/Downloads/etf-Satrix Global Balanced FoF.xlsx'
...
try:
    ...
    # FoF usually means Fund of Funds, holding other ETFs or funds
    new_etf = {
        "id": "STXGB", 
        "name": "Satrix Global Balanced FoF",
        "provider": "Satrix",
        "holdings": holdings
    }
